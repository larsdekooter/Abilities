...
public class VeinMineAxeItem extends VeinMineDiggerItem {
    ...
    public VeinMineAxeItem(float v, float v1, Tier tier, TagKey<Block> blockTagKey, Properties properties) {
