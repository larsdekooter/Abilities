...
public class VeinMineHoeItem extends VeinMineDiggerItem{
    public VeinMineHoeItem(float v, float v1, Tier tier, TagKey<Block> blockTagKey, Properties properties) {
