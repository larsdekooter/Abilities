...
public class VeinMineShovelItem extends VeinMineDiggerItem{
    ...
    public VeinMineShovelItem(float v, float v1, Tier tier, TagKey<Block> blockTagKey, Properties properties) {
